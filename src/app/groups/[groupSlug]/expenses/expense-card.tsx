'use client'
import { ActiveUserBalance } from '@/app/groups/[groupSlug]/expenses/active-user-balance'
import { CategoryIcon } from '@/app/groups/[groupSlug]/expenses/category-icon'
import { DocumentsCount } from '@/app/groups/[groupSlug]/expenses/documents-count'
import { ExpenseNotes } from '@/app/groups/[groupSlug]/expenses/expense-notes'
  ...
  return (
    <div
      ...
      onClick={(e) => {
        ...
        router.push(`/groups/${urlPath}/expenses/${expense.id}/edit`)
      }}
    >
      ...
      <Link
        href={`/groups/${urlPath}/expenses/${expense.id}/edit`}
        className={cn(
