...
import { getGroupExpensesAction } from '@/app/groups/[groupSlug]/expenses/expense-list-fetch-action'
...
export function ExpenseList() {
  const { groupId, groupSlug, group } = useCurrentGroup()
...
const ExpenseListForSearch = ({
  ...
  const { group, groupSlug } = useCurrentGroup()
