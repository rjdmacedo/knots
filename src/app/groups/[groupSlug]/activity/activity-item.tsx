...
export type ActivityGroup = Pick<
  ...
  'id' | 'name' | 'slug' | 'currency' | 'currencyCode' | 'participants'
>
...
export function ActivityItem({
  ...
  const groupSlug = groupSlugProp ?? groupId
    ...
    return (
      <div
        ...
        onClick={() => {
          if (expenseExists) {
            router.push(
              `/groups/${groupSlug}/expenses/${activity.expenseId}/edit`,
            )
          }
        }}
      >
        ...
        {expenseExists && (
          <Link
            href={`/groups/${groupSlug}/expenses/${activity.expenseId}/edit`}
            className={cn(
