import { defaultTo, isUndefined, omit, omitBy } from 'lodash-es'
...
function Input({
  ...
  const cleanedProps =
    valueProp.value !== undefined ? omit(props, ['defaultValue']) : props
