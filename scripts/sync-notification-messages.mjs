...
const NOTIFICATION_PATCHES = {
  ca: {
    ...
    selectAtLeastOneFilter:
      "Selecciona almenys un membre o un esdeveniment.",
  },
  'cs-CZ': {
    filterHint:
      "Vyberte, od koho chcete dostávat upozornění a které události.",
  ...
  'de-DE': {
    ...
    selectAtLeastOneFilter:
      "Wähle mindestens ein Mitglied oder ein Ereignis.",
  },
  es: {
    filterHint:
      "Elige de quién quieres alertas y qué eventos recibir.",
    ...
    selectAtLeastOneFilter:
      "Selecciona al menos un miembro o un evento.",
  },
  fi: {
    filterHint:
      "Valitse, keneltä haluat ilmoituksia ja mitkä tapahtumat.",
  ...
  'fr-FR': {
    filterHint:
      "Choisissez de qui recevoir des alertes et quels événements.",
    ...
    selectAtLeastOneFilter:
      "Sélectionnez au moins un membre ou un événement.",
  },
  'it-IT': {
    filterHint:
      "Scegli da chi ricevere avvisi e quali eventi ricevere.",
    ...
    selectAtLeastOneFilter:
      "Seleziona almeno un membro o un evento.",
  },
  'ja-JP': {
  ...
  'nl-NL': {
    ...
    selectAtLeastOneFilter:
      "Selecteer minstens één lid of gebeurtenis.",
  },
  'pl-PL': {
    filterHint:
  ...
  'pt-BR': {
    filterHint:
      "Escolha de quem você quer alertas e quais eventos receber.",
    ...
    selectAtLeastOneFilter:
      "Selecione pelo menos um membro ou evento.",
  },
  'pt-PT': {
    filterHint:
      "Escolhe de quem queres alertas e que eventos receber.",
    notifyAllMembers: "Todos no grupo",
  },
  ro: {
    filterHint:
      "Alege de la cine vrei alerte și ce evenimente să primești.",
    ...
    selectAtLeastOneFilter:
      "Selectează cel puțin un membru sau un eveniment.",
  },
  'ru-RU': {
    filterHint:
      "Выберите, от кого получать уведомления и о каких событиях.",
    ...
    selectAtLeastOneFilter:
      "Выберите хотя бы одного участника или событие.",
  },
  'tr-TR': {
    filterHint:
    ...
    selectAtLeastOneFilter:
      "En az bir üye veya olay seçin.",
  },
  'ua-UA': {
    filterHint:
      "Оберіть, від кого отримувати сповіщення та які події.",
    ...
    selectAtLeastOneFilter:
      "Оберіть принаймні одного учасника або подію.",
  },
  'zh-CN': {
